export const trackConfig = {
  models: {
    ...
    Chevrolet: {
      ...
      "Corvette C5/C6": { baseClass: "TTC" },
      "Corvette C6 Z06 & GS": { baseClass: "TTC*" },
      "Corvette C7 Z06": { baseClass: "TTB*" },
      "Corvette C7 Base/Z51/GS ": { baseClass: "TTB" },
      "Corvette C7 ZR1": { baseClass: "TTA" },
      "Corvette C8 (inc. Z51)": { baseClass: "TTB" },
      "Corvette C8 Z06": { baseClass: "TTA*" },
    },
    Dodge: {
      Viper: { baseClass: "TTB" },
  ...
  scoreLookupTable: {
    ...
    electronics: {
      "Aftermarket Engine Management System (5)": 5,
      "Data Acquisition System (0)": 0,
      "Launch Control (2)": 2,
    },
  },
